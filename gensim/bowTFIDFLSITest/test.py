...
print "\n3.向量的每一个元素代表了一个word在这篇文档中出现的次数\n"
print(corpus)
...
corpus_tfidf = models.TfidfModel.load("data.tfidf")
...
print "\n5.返回最相似的样本材料,(index_of_document, similarity) tuples\n"
print(similarity[test_corpus_tfidf_1])  
''' 
